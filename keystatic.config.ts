        ...
        hero: fields.object(
          {
            ...
            videoSonido: fields.checkbox({ label: 'Botón para activar el sonido', defaultValue: false }),
            videoTitulo: fields.text({ label: 'Título del vídeo (para Google)' }),
            videoDescripcion: fields.text({ label: 'Descripción del vídeo (para Google)', multiline: true }),
            videoFecha: fields.text({ label: 'Fecha de subida (AAAA-MM-DD)' }),
